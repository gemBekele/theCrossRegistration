    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex">
        ...
        <aside
          ...
          } fixed lg:fixed inset-y-0 left-0 z-30 w-64 h-screen bg-white dark:bg-gray-800 border-r dark:border-gray-700 transition-transform duration-200 lg:translate-x-0`}
        >
        ...
        {/* Main content */}
        <main className="flex-1 min-h-screen overflow-auto lg:pl-64">
